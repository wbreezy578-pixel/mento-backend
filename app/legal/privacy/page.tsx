...
export default function PrivacyPolicyPage() {
  return <LegalPage title="Privacy Policy" updated="September 14, 2026">
    ...
    <p>Mento uses Google Gemini to analyze Normal Chat prompts and images; OpenAI Realtime to process Live Tutor voice and generate realtime tutoring audio; and Simli and its realtime media infrastructure to render and stream the Live Tutor avatar. Mento also uses Google Cloud Run for backend hosting; Supabase for sign-in; PostgreSQL for account and learning data; Redis for short-lived coordination; Google Mobile Ads/AdMob for advertising; and Google Play for Android purchases. These providers may process information in countries outside Kenya under their own privacy and security commitments.</p>
