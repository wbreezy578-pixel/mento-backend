...
export const LIVE_TUTOR_VOICE_EVENTS = [
  ...
  'WEBVIEW_FIRST_PCM_RECEIVED', 'SIMLI_FIRST_PCM_SUBMITTED',
  'SIMLI_AUDIO_ACK',
...
const deviceEvents = new Set<LiveTutorVoiceEvent>([
  ...
  'WEBVIEW_FIRST_PCM_RECEIVED', 'SIMLI_FIRST_PCM_SUBMITTED', 'SIMLI_AUDIO_ACK',
...
export function metrics(timeline: Timeline) {
  ...
  return {
    ...
    frontendToWebviewMs: delta('FRONTEND_FIRST_PCM_RECEIVED', 'WEBVIEW_FIRST_PCM_RECEIVED'),
    webviewPrebufferWaitMs: delta('WEBVIEW_FIRST_PCM_RECEIVED', 'SIMLI_FIRST_PCM_SUBMITTED'),
    submissionToSimliAckMs: delta('SIMLI_FIRST_PCM_SUBMITTED', 'SIMLI_AUDIO_ACK'),
    submissionToSimliSpeakingSignalMs: delta('SIMLI_FIRST_PCM_SUBMITTED', 'SIMLI_SPEAKING_SIGNAL'),
