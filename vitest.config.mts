...
export default defineConfig({
  test: {
    include: [
      ...
      "lib/rateLimiter.redisReady.test.ts",
      ...
      "services/liveTutorAvatarTransportPolicy.test.ts",
      "services/liveTutorLiveKitPcmPublisher.test.ts",
      "services/liveTutorSimliLiveKitAvatarSession.test.ts",
      "services/liveTutorOpenAIRealtimeService.test.ts",
      "services/liveTutorConversationService.test.ts",
      "services/liveTutorVoiceTelemetry.test.ts",
      ...
      "services/liveTutorSessionBilling.test.ts",
